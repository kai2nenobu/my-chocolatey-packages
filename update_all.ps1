...
$Options = [ordered]@{
    ...
    Report = @{
        ...
        Params= @{                                          #Report parameters:
            ...
            UserMessage = "[![Auto Update](https://github.com/kai2nenobu/my-chocolatey-packages/workflows/Auto%20Update/badge.svg)]($env:GH_ACTIONS_BUILD_URL) | [Ignored](#ignored) | [History](#update-history) | [Force Test](https://gist.github.com/$Env:gist_id_test) | [Releases](https://github.com/$Env:github_user_repo/tags)"       #  Markdown, Text: Custom user message to show
...
$global:au_GalleryUrl   = 'https://www.myget.org/F/kai2nenobu'             #URL to package gallery, leave empty for Chocolatey Gallery
